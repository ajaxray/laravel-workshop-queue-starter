...
<head>
    ...
    <title>Central Bank Of Nauru</title>
...
<body class="bg-white min-h-screen flex flex-col text-gray-900 font-sans">
    ...
    <main class="flex-1 flex flex-col items-center justify-center text-center px-4 py-16 bg-gradient-to-b from-accent/10 to-white">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 text-accent">Welcome to the Central Bank Of Nauru</h1>
            <p class="text-lg md:text-xl text-gray-700 mb-8">Empowering Nauru's financial future. We ensure monetary stability, foster economic growth, and safeguard your trust in the nation's financial system.</p>
        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="grid md:grid-cols-3 gap-8 text-left">
                ...
                <div class="bg-white rounded shadow p-6">
                    ...
                    <p class="text-gray-700">We supervise and regulate financial institutions to ensure a sound and resilient financial system for all Nauruans.</p>
                </div>
                <div class="bg-white rounded shadow p-6">
    ...
    <section class="py-12 bg-accent text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-2xl font-bold mb-4">Partnering for Nauru's Prosperity</h2>
    ...
    <footer class="w-full bg-gray-100 text-gray-600 py-6 mt-auto">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-2">
            <span>&copy; {{ date('Y') }} Central Bank Of Nauru. All rights reserved.</span>
